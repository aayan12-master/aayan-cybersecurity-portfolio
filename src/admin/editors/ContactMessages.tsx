        ...
        {authChecked && !supabaseSession && (
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <strong style={{ textTransform: 'uppercase', letterSpacing: '0.5px', fontSize: '0.75rem' }}>Supabase Session Required</strong>
              <span style={{ color: 'var(--a-text-sec)' }}>Queries may return no protected data due to RLS policies. Please log in to see messages.</span>
            </div>
          </div>
        )}
