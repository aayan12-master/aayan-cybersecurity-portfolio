              ...
              <div key={cert.id} className="admin-list-item">
                <div className="list-item-info">
                  ...
                  <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginTop: '0.1rem' }}>
                    <span className={`badge ${getCertStatusStyle(cert.status).adminBadge}`}>{cert.status}</span>
                    {cert.verificationLink && (
                      <a
                        ...
                        style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', textDecoration: 'none', padding: '0.2rem 0.6rem' }}
                      >
